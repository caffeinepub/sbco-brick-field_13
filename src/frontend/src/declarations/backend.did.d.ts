...
export interface _SERVICE {
  'decrementField' : ActorMethod<[string, bigint], undefined>,
  'getStats' : ActorMethod<[], Stats>,
  'incrementField' : ActorMethod<[string, bigint], undefined>,
  'updateStats' : ActorMethod<[UpdateStatRequest], undefined>,
}
